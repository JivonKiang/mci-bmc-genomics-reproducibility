...
This mapping describes the public GitHub release for the BMC Genomics manuscript. The repository contains selected code and aggregate tables only.
...
Sample-level, donor-level and cell-level tables are deliberately omitted from this public release. The complete audit package remains local to the submission workspace.
